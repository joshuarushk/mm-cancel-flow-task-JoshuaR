...
- Visit `/cancel` to start the flow.
- Scripts: `npm run db:setup` then `npm run dev`.
- Place your provided images at `public/main-image.png` and `public/profile-image.png`.
